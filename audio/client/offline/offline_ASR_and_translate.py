...
def translate(query, src_lang, dest_lang):    
    # 百度翻译
    appid = '20240319001998531'
    secret_key = 'fq6ekiMRvAR6BW1HwYsn'
...
def ASR_and_translate(input, input_lang, output_lang='zh'):
    s_time = time.time()
...
# if __name__ == "__main__":
    ...
    # a = ASR_and_translate(input_a, native_lang='zh')
    # print(input_a, a)
    
    # input_b = 'test_data/en2.wav'
    # b = ASR_and_translate(input_b, native_lang='zh')
    # print(input_b, b)
    
    # input_c = "こんにちは、お元気ですか？"
    # c = ASR_and_translate(input_c, native_lang='zh')
    # print(input_c, c)
